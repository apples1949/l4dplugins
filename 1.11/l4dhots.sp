...
public void OnPluginStart()
{
	...
	hCvarPillHot =			CreateConVar("l4d_pills_hot",				"1",	"是否开启止痛药缓慢回血",				FCVAR_NOTIFY|FCVAR_SPONLY, true, 0.0, true, 1.0);
	hCvarPillInterval =		CreateConVar("l4d_pills_hot_interval",		"0.1",	"多少秒回一次血(秒)",			FCVAR_NOTIFY|FCVAR_SPONLY, true, 0.00001);
	hCvarPillIncrement =	CreateConVar("l4d_pills_hot_increment",		"5",	"每次回多少量",	FCVAR_NOTIFY|FCVAR_SPONLY, true, 1.0);
	hCvarPillTotal =		CreateConVar("l4d_pills_hot_total",			"75",	"总回血量",		FCVAR_NOTIFY|FCVAR_SPONLY, true, 0.0);
	...
	hCvarAdrenHot = 		CreateConVar("l4d_adrenaline_hot",				"1",	"是否开启止痛药缓慢回血",			FCVAR_NOTIFY|FCVAR_SPONLY, true, 0.0, true, 1.0);
	hCvarAdrenInterval =	CreateConVar("l4d_adrenaline_hot_interval",		"0.1",	"多少秒回一次血(秒)",			FCVAR_NOTIFY|FCVAR_SPONLY, true, 0.00001);
	hCvarAdrenIncrement =	CreateConVar("l4d_adrenaline_hot_increment",	"2",	"每次回多少量",	FCVAR_NOTIFY|FCVAR_SPONLY, true, 1.0);
	hCvarAdrenTotal =		CreateConVar("l4d_adrenaline_hot_total",		"40",	"总回血量",		FCVAR_NOTIFY|FCVAR_SPONLY, true, 0.0);
