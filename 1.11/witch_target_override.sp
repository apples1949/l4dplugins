...
public void OnPluginStart()
{
	...
	g_hCvarKillOverride = CreateConVar("witch_target_override_kill", "1", "如果为1，则目标玩家死亡之后继续追杀其他生还者", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hCvarIncapOverrideHealth = CreateConVar("witch_target_override_incap_health_add", "100", " 如果Witch在目标玩家倒地之后继续追杀其他生还者，增加数值血量. (0=关闭)", FCVAR_NOTIFY, true, 0.0, true, 9999.0);
	g_hCvarKillOverrideHealth = CreateConVar("witch_target_override_kill_health_add", "400", "如果Witch在目标玩家死亡之后继续追杀其他生还者，增加数值血量. (0=关闭)", FCVAR_NOTIFY, true, 0.0, true, 9999.0);
	...
	g_hWitchFollowSpeed = CreateConVar("Witch的跟踪速度", "45.0", "Witch's following speed.", FCVAR_NOTIFY, true, 1.0);
