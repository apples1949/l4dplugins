...
public void OnPluginStart()
{
	...
	hSmgTimeCvar			= CreateConVar("l4d2_smg_reload_clip_time", 			"1.04", "uzi冲锋枪换弹时间"							  , FCVAR_NOTIFY, true, 0.0);
	...
	hPistolTimeCvar 		= CreateConVar("l4d2_pistol_reload_clip_time", 			"1.2",  "单手枪的换弹时间"								  , FCVAR_NOTIFY, true, 0.0);
	hDualPistolTimeCvar 	= CreateConVar("l4d2_dualpistol_reload_clip_time", 		"1.75", "双手枪的换弹时间"								  , FCVAR_NOTIFY, true, 0.0);
	hSmgSilencedTimeCvar	= CreateConVar("l4d2_smgsilenced_reload_clip_time", 	"1.05", "smg消音冲锋枪的换弹时间"						  , FCVAR_NOTIFY, true, 0.0);
	...
	hMangumTimeCvar			= CreateConVar("l4d2_mangum_reload_clip_time", 			"1.18", "马格南的换弹时间"								  , FCVAR_NOTIFY, true, 0.0);
	hM60TimeCvar			= CreateConVar("l4d2_m60_reload_clip_time", 			"1.2",  "m60的换弹时间"								  , FCVAR_NOTIFY, true, 0.0);
	hSmgClipCvar			= CreateConVar("l4d2_smg_reload_clip", 					"50", 	"uzi冲锋枪的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hRifleClipCvar			= CreateConVar("l4d2_rifle_reload_clip", 				"50", 	"步枪m4的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hHuntingRifleClipCvar	= CreateConVar("l4d2_huntingrifle_reload_clip", 		"15", 	"木制猎枪的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hPistolClipCvar			= CreateConVar("l4d2_pistol_clip", 						"15", 	"单手枪的弹夹容量"								  , FCVAR_NOTIFY, true, 1.0);
	hDualPistolClipCvar		= CreateConVar("l4d2_dualpistol_clip", 					"30", 	"双手枪的弹夹容量"								  , FCVAR_NOTIFY, true, 1.0);
	hSmgSilencedClipCvar	= CreateConVar("l4d2_smgsilenced_clip", 				"50", 	"smg消音冲锋枪的弹夹容量"						  , FCVAR_NOTIFY, true, 1.0);
	hSmgMP5ClipCvar			= CreateConVar("l4d2_smgmp5_clip", 						"50", 	"mp5冲锋枪的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hAK47ClipCvar			= CreateConVar("l4d2_ak47_clip", 						"40", 	"ak47步枪的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hRifleDesertClipCvar	= CreateConVar("l4d2_desertrifle_clip", 				"60", 	"scar步枪的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hSniperMilitaryClipCvar	= CreateConVar("l4d2_snipermilitary_clip", 				"30", 	"军用狙击枪的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hGrenadeClipCvar		= CreateConVar("l4d2_grenade_clip", 					"3", 	"榴弹发射器的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hSG552ClipCvar			= CreateConVar("l4d2_sg552_clip", 						"50", 	"sg552步枪的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hAWPClipCvar			= CreateConVar("l4d2_awp_clip", 						"10", 	"awp狙击枪的弹夹容量"							  , FCVAR_NOTIFY, true, 1.0);
	hScoutClipCvar			= CreateConVar("l4d2_scout_clip", 						"15", 	"scout狙击枪的弹夹容量"						  , FCVAR_NOTIFY, true, 1.0);
	hMangumClipCvar			= CreateConVar("l4d2_mangum_clip", 						"8", 	"马格南的弹夹容量"								  , FCVAR_NOTIFY, true, 1.0);
	hM60ClipCvar			= CreateConVar("l4d2_m60_clip", 						"150", 	"m60的弹夹容量"								  , FCVAR_NOTIFY, true, 1.0);
//译者注：插件设定的换弹时间比游戏换的时间短 
	GetCvars();
