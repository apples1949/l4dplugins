...
static char MSG_KICK_REASON[] = "抱歉，额外的位置便于管理员进服管理..";
...
public void OnAllPluginsLoaded()
{
        ...
        g_hCvarReservedSlots = CreateConVar("l4d_reservedslots_adm", "1", "预留几个位置给管理员 (0=关闭)", CVAR_FLAGS, true, 0.0);
        g_hAccess = CreateConVar("l4d_reservedslots_flag", "z", "使用预留的位置所需要的权限. (空 = 所有人, -1=没有人)", CVAR_FLAGS);
        g_hHideSlots = CreateConVar("l4d_reservedslots_hide", "1", "如果为1，则隐藏预留的位置(从最大人数'sv_maxplayers'中减去'l4d_reservedslots_adm')", CVAR_FLAGS, true, 0.0, true, 1.0);
