...
void CreateStringMap()
{
	...
	g_smModelToName.SetString("models/w_models/weapons/w_eq_defibrillator.mdl", "除颤器");
	...
	g_smModelToName.SetString("models/w_models/weapons/w_eq_pipebomb.mdl", "手雷");
	g_smModelToName.SetString("models/w_models/weapons/w_laser_sights.mdl", "镭射装置");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_incendiary_ammopack.mdl", "燃烧弹药包");
	g_smModelToName.SetString("models/w_models/weapons/w_eq_explosive_ammopack.mdl", "爆炸弹药包");
	...
	g_smModelToName.SetString("models/w_models/weapons/w_pistol_a.mdl", "小手枪");
	...
	g_smModelToName.SetString("models/w_models/weapons/w_desert_rifle.mdl", "三连发步枪");
	g_smModelToName.SetString("models/w_models/weapons/w_shotgun_spas.mdl", "Spas战斗霰弹枪");
	g_smModelToName.SetString("models/w_models/weapons/w_autoshot_m4super.mdl", "自动霰弹枪");
	g_smModelToName.SetString("models/w_models/weapons/w_sniper_mini14.mdl", "猎枪");
	...
	g_smModelToName.SetString("models/props_junk/gnome.mdl", "侏儒小人像");
	g_smModelToName.SetString("models/w_models/weapons/w_cola.mdl", "可乐瓶");
	g_smModelToName.SetString("models/w_models/weapons/50cal.mdl", "重机枪");
	g_smModelToName.SetString("models/w_models/weapons/w_minigun.mdl", "迷你机枪");
	g_smModelToName.SetString("models/props/terror/exploding_ammo.mdl", "爆炸弹药包");
	...
	g_smModelToName.SetString("models/weapons/melee/w_cricket_bat.mdl", "板球板");
...
void CreateInstructorHint(int client, const float vOrigin[3], const char[] sItemName, int iEntity, EHintType type)
{
	...
	switch(type)
	{
		...
		case view_as<EHintType>(eSpotMarker):
		{
			...
			{
				FormatEx(sCaption, sizeof sCaption, "%N 在这里做了标记", client);
