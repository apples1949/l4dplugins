...
new	String:logfilepath[16];\
/* 存档和排名 */
new String:SavePath[16];
...
public void OnPluginStart()
{
	...
	/* 设置Save和Ranking位置 */
	BuildPath(Path_SM, SavePath, 15, "data/RPGSave.txt");
	...
	g_BShuiLimit = CreateConVar("BS_limit", "50");
			...
			switch(StringToInt(item)) 
			{
				...
				{	
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了马格南手枪",param1);
					}
				}
				case SMG:	
				{	
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了10点B数购买了UZI冲锋枪",param1);
					}
				}
				case SMGSILENCED:	
				{	
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了10点B数购买了SMG冲锋枪",param1);
					}
				}
				case PUMPSHOTGUN1:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了10点B数购买了一代单发霰弹枪",param1);
					}
				}
				case PUMPSHOTGUN2:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了10点B数购买了二代单发霰弹枪",param1);
					}
				}
				case AUTOSHOTGUN1:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了一代连发霰弹枪",param1);
					}
				}
				case AUTOSHOTGUN2:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了二代连发霰弹枪",param1);
					}
				}
				case HUNTING1:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了一代狙击枪",param1);
					}
				}
				case HUNTING2:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了二代狙击枪",param1);
					}
				}
				...
				case M16:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了M16步枪",param1);
					}
				}
				case AK47:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了AK47步枪",param1);
					}
				}
				case SCAR:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了SCAR步枪",param1);
					}
				}
				case AWP:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了AWP狙击枪",param1);
					}
				}
				case grenadelauncher:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了榴弹发射器",param1);
					}
				}
				case sniperscout:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了鸟狙",param1);
					}
				}
				case m60:
				{
					...
					else if(IsSurvivor(param1))
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了M60",param1);
					}
				}
				case DEFIBRILLATOR:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了电击器",param1);
					}
				}
				case PAINPILLS:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了止痛药",param1);
					}
				}
				case FIRSTAIDKIT:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了急救包",param1);
					}
				}
				case GASCAN:
				{
					...
					else
					{
						...
						player_data[param1][MONEY] -= 1;
						PrintToChatAll("\x04%N\x03花了1点B数购买了油桶",param1);
					}
				}
			}
		}
