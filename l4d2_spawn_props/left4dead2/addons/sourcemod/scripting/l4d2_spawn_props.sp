...
{	
	...
	g_cvarPhysics 		= CreateConVar("l4d2_spawn_props_physics", 				"1", "是否启用菜单中的物理对象");
	g_cvarDynamic 		= CreateConVar("l4d2_spawn_props_dynamic",				"1", "是否启用菜单中的动态（非实体）物体");
	g_cvarStatic 		= CreateConVar("l4d2_spawn_props_static",				"1", "是否 启用菜单中的静态（固体）物体");
	g_cvarItem 			= CreateConVar("l4d2_spawn_props_items",				"1", "是否启用菜单中的物品和武器对象");
	g_cvarVehicles 		= CreateConVar("l4d2_spawn_props_category_vehicles",	"1", "是否启用'车辆'类别");
	g_cvarFoliage 		= CreateConVar("l4d2_spawn_props_category_foliage",		"1", "是否启用'植物'类别");
	g_cvarInterior 		= CreateConVar("l4d2_spawn_props_category_interior",	"1", "是否启用'室内'类别");
	g_cvarExterior 		= CreateConVar("l4d2_spawn_props_category_exterior",	"1", "是否启用'外观'类别");
	g_cvarDecorative 	= CreateConVar("l4d2_spawn_props_category_decorative",	"1", "是否启用'装饰'类别");
	g_cvarMisc 			= CreateConVar("l4d2_spawn_props_category_misc", 		"1", "是否启用'杂项'类别");
	g_cvarLog 			= CreateConVar("l4d2_spawn_props_log_actions", 			"0", "管理员产生对象时是否记录到日志");
	g_cvarAutoload 		= CreateConVar("l4d2_spawn_props_autoload", 			"0", "是否自动加载缓存");
	g_cvarAutoloadType 	= CreateConVar("l4d2_spawn_props_autoload_different", 	"1", "各个团队的路径是否应该不同?");
