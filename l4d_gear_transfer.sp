...
public void OnPluginStart()
{
	...
	g_hCvarNotify =			CreateConVar(	"l4d_gear_transfer_notify",			"1",			"0=关, 1=在聊天信息窗显示给于物品信息.", CVAR_FLAGS);
	...
	CreateConVar(							"l4d_gear_transfer_version",		PLUGIN_VERSION, "插件版本.", FCVAR_NOTIFY|FCVAR_DONTRECORD);
