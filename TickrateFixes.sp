...
{
	g_hPistolDelayDualies = CreateConVar("l4d_pistol_delay_dualies", "0.1", "双小手枪射击间隔的最短时间应该是多少秒",FCVAR_SPONLY | FCVAR_NOTIFY, true, 0.0, true, 5.0);
	g_hPistolDelaySingle = CreateConVar("l4d_pistol_delay_single", "0.2", "单小手枪射击间隔的最短时间应该是多少秒", FCVAR_SPONLY | FCVAR_NOTIFY, true, 0.0, true, 5.0);
	g_hPistolDelayIncapped = CreateConVar("l4d_pistol_delay_incapped", "0.2", "倒地小手枪射击间隔的最短时间应该是多少秒", FCVAR_SPONLY | FCVAR_NOTIFY, true, 0.0, true, 5.0);
