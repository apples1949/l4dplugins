...
可选-修复类(v1.2.5)(修复玩家过关后装备和属性混乱)(sorallll)  
...
自选-8角色共存(v1.84)(DeatChaos25, Mi123456 & Merudo, Lux, SilverShot)  
...
自选-动态大厅(v2.0.3)(Downtown1, Anime4000, sorallll)  
...
自选-禁用游戏自带的投票  
自选-爬梯时可开枪(v1.0)(Lux)  
自选-排行榜插件(v2.9.11)(豆瓣酱な)(HUD的include提供者为 sorallll)  
...
自选-坦克出现时根据幸存者人数增加血量和女巫随机或固定血量(v1.5.7)(Visor,豆瓣酱な)(需要自定义女巫编号插件)(新版变回按找死活生还者人数 懒得更新用旧版)  
...
[l4d2_si_ladder_booster](https://github.com/fbef0102/Rotoblin-AZMod/blob/master/SourceCode/scripting-az/l4d2_si_ladder_booster.sp)AI感染者爬梯加速 [增加cvar说明](https://github.com/apples1949/l4dplugins/blob/main/l4d2_si_ladder_booster.sp)  
...
[lfd_noTeamSay](https://github.com/fbef0102/L4D1_2-Plugins/tree/master/lfd_noTeamSay)将仅团队信息转为公开信息 隐藏聊天框发出的插件指令 [本仓库地址](https://github.com/apples1949/l4dplugins/blob/main/lfd_noTeamSay.sp)  
...
[l4d_tanklimit](https://github.com/fbef0102/L4D1_2-Plugins/tree/master/l4d_tanklimit) 限制服务器上的最大坦克数量 [本仓库地址](https://github.com/apples1949/l4dplugins/blob/main/l4d_tanklimit.sp)  
...
[l4d_flying_car](https://github.com/fbef0102/L4D2-Plugins/tree/master/l4d_flying_car)c8m5救援直升机替换成出租车或者警车 [翻译cvar说明及游戏文本](https://github.com/apples1949/l4dplugins/blob/main/l4d_flying_car.sp)  
...
[l4d_coop_markers](https://forums.alliedmods.net/showthread.php?t=321288) 路程进度主动显示 [本仓库地址](https://github.com/apples1949/l4dplugins/tree/main/l4d_coop_markers)  
...
[l4d_lift_music](https://forums.alliedmods.net/showthread.php?t=157267) 电梯放音乐 [本仓库地址](https://github.com/apples1949/l4dplugins/tree/main/l4d_lift_music)  
[l4d_incapped_weapons](https://forums.alliedmods.net/showthread.php?t=322859) 倒地允许使用任何武器(使用1.16版本无自救功能的版本 不如专门的自救插件 就算是我现在用的有bug)  [翻译cvar说明](https://github.com/apples1949/l4dplugins/tree/main/l4d_incapped_weapons)   
[l4d_plane](https://forums.alliedmods.net/showthread.php?t=181517) 显示坠机动画 [自翻cvar说明及文本](https://github.com/apples1949/l4dplugins/tree/main/l4d_plane_crash)  
...
[l4d2_incapped_crawling](https://forums.alliedmods.net/showthread.php?p=1291588) 倒地可爬行及爬行第三人称 [自用去除文本提示](https://github.com/apples1949/l4dplugins/tree/main/l4d2_incapped_crawling)   
...
[l4d_pipebomb_shove](https://forums.alliedmods.net/showthread.php?p=1733534) 设置引诱手雷伤害及手雷可吸附感染者头部(主要是设置伤害) [翻译cvar说明](https://github.com/apples1949/l4dplugins/tree/main/l4d_pipebomb_shove)   
...
[l4d_anti_rush](https://forums.alliedmods.net/showthread.php?t=322392) 反跑图 [自翻cvar介绍和文本](https://github.com/apples1949/l4dplugins/tree/main/l4d_anti_rush)   
...
[l4d2_riot_penetration](https://forums.alliedmods.net/showthread.php?t=341750)子弹可穿透防爆僵尸[本仓库地址](https://github.com/apples1949/l4dplugins/tree/main/l4d2_riot_penetration)  
...
[l4d2_melee_in_the_saferoom](https://forums.alliedmods.net/showthread.php?p=2719475) 安全区生成近战 使用[sorallll的git版本](https://github.com/umlka/l4d2/blob/main/l4d2_melee_in_the_saferoom/l4d2_melee_in_the_saferoom.sp)并[翻译cvar说明](https://github.com/apples1949/l4dplugins/blob/main/l4d2_melee_in_the_saferoom.sp)  
[l4d2_transition_info_fix](https://forums.alliedmods.net/showthread.php?p=2762953) [使用sorallll的git版本](https://github.com/umlka/l4d2/tree/main/l4d2_transition_info_fix) [本仓库地址](https://github.com/apples1949/l4dplugins/tree/main/l4d2_transition_info_fix)  
[l4d2_hostname](https://github.com/umlka/l4d2/blob/main/l4d2_hostname) 服务器中文名加上游戏进度显示 [本仓库地址](https://github.com/apples1949/l4dplugins/blob/main/l4d2_hostname.sp)  
[jockey_ride_stuck_fix](https://forums.alliedmods.net/showthread.php?p=2756577) 修复猴子因被控玩家/bot被踢出游戏而导致卡在半空的问题 [使用作者git版本](https://github.com/umlka/l4d2/tree/main/jockey_ride_stuck_fix) [本仓库地址](https://github.com/apples1949/l4dplugins/blob/main/jockey_ride_stuck_fix.sp)  
[control_zombies](https://github.com/umlka/l4d2/tree/main/control_zombies)战役模式下玩家可扮演感染者/生还者玩家可叛变坦克 [本仓库地址](https://github.com/apples1949/l4dplugins/tree/main/control_zombies)  
[specialspawner](https://github.com/umlka/l4d2/tree/main/specialspawner) 刷特插件 [本仓库地址](https://github.com/apples1949/l4dplugins/blob/main/specialspawner.sp)  

[DeathChaos25](https://forums.alliedmods.net/member.php?u=244944):  
[l4d2_DefibUsingBots](https://forums.alliedmods.net/showthread.php?t=261566) 强制bot使用电击器 [本仓库地址](https://github.com/apples1949/l4dplugins/blob/main/l4d2_DefibUsingBots.sp)  
...
[l4d_triggers_ignore_incap](https://forums.alliedmods.net/showthread.php?p=2732062) 机关不会因为倒地的玩家而无法开始 [本仓库地址](https://github.com/apples1949/l4dplugins/tree/main/l4d_triggers_ignore_incap.sp)  
...
[l4d2_random_glow_item](https://forums.alliedmods.net/showthread.php?t=329617) 所有武器道具靠近可隔墙发光 [翻译cvar说明、插件文本及数据文件说明](https://github.com/apples1949/l4dplugins/tree/main/l4d2_random_glow_item)  
[l4d_remove_item_collision](https://forums.alliedmods.net/showthread.php?t=328327)将所有武器或携带物的碰撞更改为仅与世界和静态物体发生碰撞 [本仓库地址](https://github.com/apples1949/l4dplugins/tree/main/l4d_remove_item_collision.sp)  
...
[l4d2_pistol_delay](https://github.com/SirPlease/L4D2-Competitive-Rework/blob/master/addons/sourcemod/scripting/l4d2_pistol_delay.sp) 修复高tick下手枪射击间隔过快问题（对连射插件的快速射击无效）[翻译cvar说明](https://github.com/apples1949/l4dplugins/blob/main/l4d2_pistol_delay)  
...
[l4d2_block_stumble_scratches](https://github.com/fdxx/l4d2_plugins/blob/main/l4d2_block_stumble_scratches.sp)特感Bot被推后的硬直时间内，阻止使用右键抓人 [本仓库地址](https://github.com/apples1949/l4dplugins/blob/main/l4d2_block_stumble_scratches)  
...
[Ernecio](https://forums.alliedmods.net/member.php?u=294449):  
[l4d_healing_field](https://forums.alliedmods.net/showthread.php?t=324501) 坦克死亡留下治疗阵 [自翻cvar说明及文本 修改回血上限150](https://github.com/apples1949/l4dplugins/blob/main/l4d_healing_field.sp)  

[tRololo312312](https://forums.alliedmods.net/member.php?u=259918):  
[lagpreventor](https://forums.alliedmods.net/showthread.php?p=2758895) 优化某些三方图炸ping问题 [本仓库地址](https://github.com/apples1949/l4dplugins/blob/main/lagpreventor.sp)  

[MatthewClair](https://github.com/MatthewClair):  
[flying_ghosts](https://github.com/MatthewClair/sourcemod-plugins/blob/master/flying_ghosts/flying_ghosts.sp) 特感灵魂飞行 [本仓库地址](https://github.com/apples1949/l4dplugins/blob/main/flying_ghosts.sp)  
...
[l4d_automatic_weapons](https://forums.alliedmods.net/showthread.php?t=322259) 半自动武器全自动射击 [自翻cvar介绍和文本](https://github.com/apples1949/l4dplugins/blob/main/l4d_automatic_weapons.sp)  
