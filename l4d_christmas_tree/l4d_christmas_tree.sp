...
public void OnPluginStart()
{
	...
	if( g_bLeft4Dead2 )
	{
		...
		g_hCvarItems =	CreateConVar(	"l4d_tree_items",			"80,100,25,25,25,40,15,15,15,2,2,2,5,5,5,2,5,1,1,2,0,2,5,0,0,2,0,5,1,5",		"以下物品武器生成百分比几率 数值必须用逗号分隔 肾上腺素, 药丸, 燃烧瓶, 自制手雷, 胆汁, 医疗包, 电击器, 高爆弹药包, 燃烧弹药包, M4步枪, 1代连喷, 木狙, mac冲锋枪, 木喷, 小手枪, 铁喷, 三连发步枪, 榴弹发射器, M60, AK47, Sg552瞄准步枪, SPAS连喷, SMG消音冲锋枪, MP5冲锋枪, AWP, 军狙, 鸟狙, 马格南, 电锯, 其他近战", CVAR_FLAGS );
