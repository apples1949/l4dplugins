...
public void OnPluginStart()
{
	...
	g_hPipeBombDisable = CreateConVar( "anti_friendly_fire_immue_explode", "0",
								"如果为1, 关闭手雷,煤气罐,氧气瓶的爆炸友伤.",
								FCVAR_NOTIFY, true, 0.0, true, 1.0 );

	g_hDamageShield = CreateConVar( "anti_friendly_fire_damage_sheild", "2",
								"低于多少伤害不造成友伤 (0=关闭).",
								FCVAR_NOTIFY, true, 0.0);

	g_hIncapProtect = CreateConVar( "anti_friendly_fire_incap_protect", "0",
								"如果为1, 如果友伤会试对方倒地，则不造成友伤.",
								FCVAR_NOTIFY, true, 0.0, true, 1.0 );	

	g_hDamageMulti = CreateConVar( "anti_friendly_fire_damage_multi", "1.0",
								"友伤加倍反弹多少伤害. (1.0=反伤一样的友伤)",
