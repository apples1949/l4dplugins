...
public void OnPluginStart()
{
	...
	RegConsoleCmd("sm_pause", Command_SMForcePause, ADMFLAG_ROOT, "Adm forces the game to pause/unpause");
...
public Action Command_SMForcePause(int client, int args)
{
	...
	{
		PrintToChatAll("\x01[\x05TS\x01] The game has been unpaused");
	...
	{
		PrintToChatAll("\x01[\x05TS\x01] The game has been paused",client);
		PrintToChatAll("\x01To unpause the game, use \x04!pause\x01");
		Pause(client);
	}
	return Plugin_Handled;
}
