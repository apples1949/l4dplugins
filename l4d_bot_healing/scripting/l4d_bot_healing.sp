...
public void OnPluginStart()
{
	...
	g_hCvarFirst = CreateConVar("l4d_bot_healing_first", g_bLeft4Dead2 ? "1.0" : "15.0", "当bot血量低于此值时，允许其打包", CVAR_FLAGS);
	g_hCvarPills = CreateConVar("l4d_bot_healing_pills", g_bLeft4Dead2 ? "16.0" : "39.0", "当bot血量低于此值时，允许其吃药", CVAR_FLAGS);
